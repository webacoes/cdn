<?PHP
    ...
    /* Check Session */
	if(isset($_COOKIE["6175e5f5281f81728ded56ab632df594b4a7b15b"]) && isset($_SESSION["password"]) ) {
		if ( $_COOKIE["6175e5f5281f81728ded56ab632df594b4a7b15b"] == $_SESSION["password"]) {
			null;
		}
		else {
			header("Location:login.php?id=".$page_current);
		}
	}else{
		header("Location:login.php?id=".$page_current);
	}
    ...
    include("xheader.php");
    include("controllers/controller_system.php");
?>    

<!-- BEGIN: Vendor CSS-->
<link rel="stylesheet" type="text/css" href="app-assets2/vendors/css/vendors.min.css">
<!-- END: Vendor CSS-->

<!-- BEGIN: Theme CSS-->
<link rel="stylesheet" type="text/css" href="app-assets2/css/bootstrap.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/bootstrap-extended.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/colors.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/components.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/themes/dark-layout.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/themes/semi-dark-layout.css">

<!-- BEGIN: Page CSS-->
<link rel="stylesheet" type="text/css" href="app-assets2/css/core/menu/menu-types/vertical-menu.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/core/colors/palette-gradient.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/pages/app-chat.css">
<link rel="stylesheet" type="text/css" href="app-assets2/vendors/css/extensions/swiper.min.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/plugins/extensions/swiper.css">
<link rel="stylesheet" type="text/css" href="app-assets2/css/plugins/forms/wizard.css">
<link rel="stylesheet" type="text/css" href="assets2/wizard/style_wizard.css<?PHP echo time();?>">

<!-- END: Page CSS-->

<!-- BEGIN: Custom CSS-->
<link rel="stylesheet" type="text/css" href="assets2/css/style.css">
<script src="utils/util.js?<?PHP echo time();?>" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="assets2/style_payment.css">
...
/*
            ...
            box-shadow: inset 0 -3px 0 0 rgb(0 0 0 / 20%) !important;
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Seja Usuário PRO </h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section id="component-swiper-centered-slides">
                <div class="card bg-transparent shadow-none" style="margin-bottom: 0px">
                    <div class="card-content">
                        <div class="card-body" style="padding: 0px">
                            <div class="swiper-centered-slides swiper-container p-1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide rounded swiper-shadow" onclick="selectYear();" style="padding-top: 10px; padding-bottom: 10px; "> 
                                        <div class="swiper-text pt-md-1 pt-sm-50">
                                            <h1 class="font-larger-1 primary">MENSAL</h1> 
                                            
                                            <h3 class="text-dark">R$ 14,90/mês</h3>
                                          
                                            <h6>1 mês</h6>
                                        </div>
                                    </div>
                                
                                    <div class="swiper-slide rounded swiper-shadow" onclick="selectMonth();"  style="padding-top: 10px; padding-bottom: 10px; "> 
                                        <div class="ribbon ribbon-top-right danger"><span>DESCONTO</span></div> 
                                       <i class="fa fa-star text-primary font-large-1"></i>
                                        <div class="swiper-text pt-md-1 pt-sm-50">
                                            <h1 class="font-larger-1 primary">ANUAL</h1> 
                                           
                                            <h3 class="text-dark">R$ 149,00/ano</h3>
                                            <h6>12 meses</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-button-next" id="btnPrevious"></div>
                                <div class="swiper-button-prev" id="btnNext"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card border-primary text-center bg-transparent">
                        <div class="card-content">
                            <div class="card-body">
                                <h4 class="card-title">Cancele o plano PRO quando você quiser!</h4>
                                <p class="card-text" style="margin-bottom: 0px;">Não há fidelidade ou prazo mínimo para o cancelamento.</p>
                                <!--<p class="card-text">Para cancelar, nos envie um e-mail que cancelamos imediatamente.</p>-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body pt-0">
                                        ...
                                        <!-- Step 1 -->
                                            <h6><i class="step-icon feather icon-award"></i> Plano</h6>
                                            <fieldset>
                                                            ...
                                                            <div class="card-body" style="padding: 0px">
                                                                <div class="swiper-centered-slides swiper-container p-1">
                                                                    <div class="swiper-wrapper">
                                                                                ...
                                                                                <div class="swiper-slide rounded swiper-shadow" onclick="selectYear();" style="    padding-top: 10px;padding-bottom: 10px;     padding-left: 25px;     padding-right: 25px;     margin-right: 20px;"> 
                                                                                    <div class="swiper-text pt-md-1 pt-sm-50">
                                                                                        <h1 class="font-larger-1 primary">MENSAL</h1> 
                                                                                ...
                                                                                <div class="swiper-slide rounded swiper-shadow" onclick="selectMonth();"  style="    padding-top: 10px;     padding-bottom: 10px; padding-left: 25px;  margin-right: 30px; padding-right: 70px; "> 
                                                                                    <div class="ribbon ribbon-top-right danger"><span>DESCONTO</span></div> 
                                                                                    <!--<i class="fa fa-star text-primary font-large-1"></i>-->
                                                                                    <div class="swiper-text pt-md-1 pt-sm-50">
                                                                                        <h1 class="font-larger-1 primary">ANUAL</h1> 
                                            ...
                                            <!-- Step 1 -->
                                            <h6><i class="step-icon feather icon-credit-card"></i> Pagamento</h6>
                                            <fieldset>
                                                                        ...
                                                                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            ...
                                                                            <g id="Front">
                                                                                <g id="CardBackground">
                                                                                    <g id="Page-1_1_">
                                                                                        <g id="amex_1_">
                                                                                            <path id="Rectangle-1_1_" class="darkcolor --indigo " d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40
                                                                                    C0,17.9,17.9,0,40,0z" />
                                                                                        </g>
                                                                                    </g>
                                                                                    <path class="lightcolor dark" style="color: #7358E7" d="M750,431V193.2c-217.6-57.5-556.4-13.5-750,24.9V431c0,22.1,17.9,40,40,40h670C732.1,471,750,453.1,750,431z" />
                                                                                </g>
                                                                                ...
                                                                                <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">vencimento</text>
                                                                    ...
                                                                    <div class="back">
                                                                        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            ...
                                                                            <g id="Back">
                                                                                <g id="Page-1_2_">
                                                                                    <g id="amex_2_">
                                                                                        <path id="Rectangle-1_2_" class="darkcolor --indigo" d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40
                                                                                C0,17.9,17.9,0,40,0z" />
                                                                                    </g>
                                                                                </g>
                                                            ...
                                                            <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="field-container">
                                                                            <label for="cardnumber">Número do Cartão</label><div id="generatecard" style="display: none"></div>
                                                                            <input id="cardnumber" 
                                                                                   name="cardnumber"
                                                                                    class="font-md-3 text-bold-500 text-center required" 
                                                                                    type="text" 
                                                                                    pattern="[0-9]*" 
                                                                                    inputmode="numeric" 
                                                                ...
                                                                <div class="row mt-1">
                                                                    <div class="col-md-12">
                                                                        <div class="field-container">
                                                                            ...
                                                                            <input  type="text"  id="name" name="name" class="text-uppercase text-bold-500 required" maxlength="40"  >
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row mt-1">
                                                                    <div class='col-md-3'>
                                                                        <div class="field-container">
                                                                            <label for="expirationdate">Vencimento (MM/YY)</label>
                                                                            <input id="expirationdate"  name="expirationdate" class="text-center text-bold-500 required" type="text" pattern="[0-9]*" inputmode="numeric">
                                                                        </div>
                                                                    </div>
                                                                    <div class='col-md-3'>
                                                                        <div class="field-container">
                                                                            <label for="securitycode">Código Segurança CVV</label>
                                                                            <input id="securitycode" name="securitycode" class="text-center text-bold-500 required"  type="text" pattern="[0-9]*" inputmode="numeric" maxlength="3" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="field-container">
                                                                            <label for="cpf">CPF Titular</label>
                                                                            <input id="cpf" name="cpf" class="text-center text-uppercase text-bold-500 required" maxlength="14" type="text">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <!-- Step 2 -->
                                            <h6><i class="step-icon feather icon-check"></i> Concluir</h6>
                                            <fieldset>
                                                <div class="row mt-1">
                                                    <div class="col-md-3">
                                                        <div class="field-container">
                                                            <label for="postalCode">CEP</label>
                                                            <input id="postalCode" name="postalCode" class="text-center text-bold-500 required" maxlength="9" type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-1">
                                                    <div class="col-md-5">
                                                        <div class="field-container">
                                                            <label for="street">Endereço da Fatura</label>
                                                            <input id="street" name="street" class="text-bold-500 required" maxlength="100" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="field-container">
                                                            <label for="number">Número</label>
                                                            <input id="number" name="number" class="text-bold-500 required" maxlength="20" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="field-container">
                                                            <label for="complement">Complemento</label>
                                                            <input id="complement" name="complement" class="text-bold-500 " maxlength="100" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="field-container">
                                                            <label for="district">Bairro</label>
                                                            <input id="district" name="district" class="text-bold-500 required" maxlength="50" type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="field-container">
                                                            <label for="state">Estado (XX)</label>
                                                            <input id="state" name="state"  class="text-center text-uppercase text-bold-500 required" maxlength="2" type="text">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="field-container">
                                                            ...
                                                            <input id="city" name="city" class="text-bold-500 text-uppercase required" maxlength="50" type="text">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="field-container">
                                                            ...
                                                            <input id="phone" name="phone"  class="text-bold-500 required" maxlength="20" type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
    ...
    <!-- Modal -->
    <div class="modal fade text-left " id="open_modal"  >
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollableX" role="document">
        </div>
    </div>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="app-assets2/vendors/js/vendors.min.js"></script>
    <script src="app-assets2/vendors/js/extensions/swiper.min.js"></script>
    <script src="app-assets2/vendors/js/extensions/jquery.steps.min.js"></script>
    <script src="app-assets2/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <script src="app-assets2/vendors/js/forms/select/select2.full.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="app-assets2/js/core/app-menu.js"></script>
    <script src="app-assets2/js/core/app.js"></script>
    <script src="app-assets2/js/scripts/components.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="app-assets2/js/scripts/pages/app-chat.js"></script>
    <script src="app-assets2/js/scripts/extensions/swiper.js"></script>
    <script src="app-assets2/js/scripts/forms/wizard-steps.js<?PHP time();?>"></script>
    <script src="app-assets2/js/scripts/forms/form-select2.js"></script>
    <!-- END: Page JS-->
    ...
    <script src="assets2/js/mask/jquery.maskedinput.js" type="text/javascript"></script>
    <script>
    jQuery(function($){
    ...
    <script>
        function generatePayment(){
            ...
            console.log('1');
            var numero_cc = $('#cardnumber').val();
            var vencimento = $('#expirationdate').val();
            var nome = $('#name').val();
            ...
            var cpf = $('#cpf').val();
            var birthDate = '01/01/1990'; //$('#birthDate').val();

            if(Iugu.utils.validateCreditCardNumber(numero_cc) == false){
                $('#cardnumber').focus();
                swal('Número do cartão de crédito inválido.', '', 'error');
                return;
            }

            if(nome.length < 2){
                $('#name').focus();
                swal('O Nome precisa ter pelo menos 2 caracteres.', '', 'error');
                return;
            }

            if(Iugu.utils.validateExpirationString(vencimento) == false){
                $('#expirationdate').focus();
                swal('Data de vencimento inválida.', '', 'error');
                return;
            }

            if(cvv.length != 3 || $.isNumeric(cvv) == false){
                $('#securitycode').focus();
                swal('Código seguranca CVV inválido.', '', 'error');
                return;
            }

            var unmasked = unmask(cpf);
            if(cpf.length < 6){
                $('#cpf').focus();
            ...
            /*
            var unmasked = unmask(birthDate);
            if(birthDate.length < 8){
                $('#birthDate').focus();
                swal('Nascimento inválido.', '', 'error');
                return;
            }
            */
            ...
            if(street.length < 4){
                $('#street').focus();
                swal('Endereço da Fatura precisa ter pelo menos 4 caracteres.', '', 'error');
                return;
            }

            if(number.length == 0){
                $('#number').focus();
                swal('O número é obrigatório.', '', 'error');
                return;
            }

            if(district.length < 3){
                $('#district').focus();
                swal('Bairro precisa ter pelo menos 3 caracteres.', '', 'error');
                return;
            }

            var unmasked = unmask(postalCode);
            ...
            if(city.length < 3){
                $('#city').focus();
                swal('Cidade precisa ter pelo menos 3 caracteres.', '', 'error');
                return;
            }

            if(state.length < 2){
                $('#state').focus();
                swal('Estado inválido.', '', 'error');
                return;
            }

            var unmasked = unmask(phone);
            if(unmasked.length < 10){
                $('#phone').focus();
                swal('Número de telefone inválido.', '', 'error');
                return;
            }

            var split = vencimento.split("/");
            var mes_vencimento = split.length > 0 ? split[0] : '';
            var ano_vencimento = split.length > 1 ? split[1] : '';

            //Tratativas
            numero_cc.replace(' ', '') 
            numero_cc = numero_cc.replace(/\D/g, '');
            ano_vencimento = '20'+ano_vencimento;       
            ...
            //btn.innerHTML =  '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Pagando...';
            //btn.disabled = true;

            setPagseguroSession(numero_cc, cvv, mes_vencimento, ano_vencimento); 
        }

        function setPagseguroSession(numero_cc, cvv, mes_vencimento, ano_vencimento){
            var data = {
                session: 'session'
            };
            ...
            $.ajax({
                type: "POST",
                url: "http://webacoes.vag/class/InvoicePagseguro.php",
                dataType: "json",
                data: data,
                timeout: 60000, // sets timeout to infinite seconds
                success: function (data) {
                    ...
                    if(data.error == false){
                        console.log('5');
                        PagSeguroDirectPayment.setSessionId(data.session);
                        getbrand(numero_cc, cvv, mes_vencimento, ano_vencimento);
                    } else{
                        swal({
                            title: 'Houve um erro ao realizar o pagamento',
                            text: "Tente novamente",
                            type: 'error',
                            }).then((result) => {
                            if (result.value) {
                                //window.location.href ='be_pro.php';
                            }
                        });
                    }
                },
                error: function (error) {
                    ...
                    //btn = document.getElementById('btnPRO');
                    //btn.innerHTML =  'Habilitar Plano Pro'
                    //btn.disabled = false;
                },
        ...
        function getbrand(numero_cc, cvv, mes_vencimento, ano_vencimento){
            var brand = '';
            var cardBin = numero_cc.substring(0, 6);
            ...
            PagSeguroDirectPayment.getBrand({
                ...
                success: function(response) {
                    ...
                    generateToken(brand, numero_cc, cvv, mes_vencimento, ano_vencimento);
                },
        ...
        function generateToken(brand, numero_cc, cvv, mes_vencimento, ano_vencimento){
            var token = '';
            console.log('9');

            PagSeguroDirectPayment.createCardToken({
                cardNumber: numero_cc, // Número do cartão de crédito
                brand: brand, // Bandeira do cartão
                cvv: cvv, // CVV do cartão
                expirationMonth: mes_vencimento, // Mês da expiração do cartão
                expirationYear: ano_vencimento, // Ano da expiração do cartão, é necessário os 4 dígitos.
                success: function(response) {
                ...
                success: function (data) {
                    ...
                    if(data.error == false){
                        ...
                        swal({
                            ...
                            text: "Dentro de alguns instantes seu acesso PRO será liberado.",
                            type: 'success',
                            }).then((result) => {
                            if (result.value) {
        ...
        // Aplicando restrições de quantidade de caracteres e tipo
        ...
        $(document).ready(function () {
            setInputFilter(document.getElementById("name"), function(value) {
              return /^[A-Za-z .]{0,40}$/.test(value);
            });

            setInputFilter(document.getElementById("cardnumberX"), function(value) {
              return /^\d{0,16}$/.test(value);
            });

            setInputFilter(document.getElementById("securitycode"), function(value) {
        ...
        */
        ...
        function planChange(){
            var plano_mensal = $('#plano_mensal').is(":checked");
            var plano_anual = $('#plano_anual').is(":checked");

            if(plano_mensal == true){
                $('#total').val('R$ 14,90 mensal');
            } else{
                $('#total').val('R$ 149,00 anual');
            }
        }
    </script>
